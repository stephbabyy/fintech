...
const First  =({ imageUrl, altText, text, text2, text3, text4, button }: { imageUrl: string, altText: string, text: string, text2: string, text3: string, text4: string, button: string })  => {
  ...
  return (
    <div className='pt-4 w-full'>
      ...
      <Image
        src={imageUrl="/images/imageslider3.jpg"} 
        alt={altText="image1"}
        width={100}
        height={100}
      ...
      >
           ...
           <div className='text-black text-[50px]'> {text="Simplify and Secure  " }<br></br></div>
           <div className='text-black text-[60px]'> {text="Your Payments With"}<br></br></div>
           <div className='text-blue-500 text-[70px]'> {text2=" Our Solution"}<br></br></div>
